...
struct lzma_block
{
	 ...
	 *
	 * Note:        Because of the array is terminated with
 ...
 *
 * Returns:     - LZMA_OK: Size calculated successfully and stored to
 *                block.header_size.
 *              - LZMA_OPTIONS_ERROR: Unsupported version, filters or
 *                filter options.
 *              - LZMA_PROG_ERROR: Invalid values like compressed_size == 0.
 *
 * Note:        This doesn't check that all the options are valid i.e. this
 ...
 *
 * Params:
 * out_     =    Beginning of the output buffer. This must be
 ...
 *                          if an error occurs).
 * in_        =  Beginning of the input buffer. This must be
 *                          at least block.header_size bytes.
 *
 * Returns:
 ...
 *    from Block Header.
 *
 * Note:        This function must be called _after_ decoding the Block Header
 *              field so that it can properly validate Compressed Size if it
 *              was present in Block Header.
 *
 * Returns:     - LZMA_OK: block.compressed_size was set successfully.
 ...
 * is needed.
 *
 * Returns:      Unpadded Size on success, or zero on error.
 */
 ...
 *
 * Returns:     On success, total encoded size of the Block. On error,
 *              zero is returned.
 */
 ...
 *
 * Returns:     - LZMA_OK: All good, continue with lzma_code().
 *              - LZMA_MEM_ERROR
 *              - LZMA_OPTIONS_ERROR
 ...
 *
 * Params:
 * block     =  Block options: block.version_, block.check,
