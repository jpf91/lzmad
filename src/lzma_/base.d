...
struct lzma_allocator
{
	 ...
	 * nmemb  = Number of elements like in calloc(). liblzma
	 ...
	 *
	 * Returns:
     * Pointer to the beginning of a memory block of
     ...
     * Params:
	 * opaque = lzma_allocator.opaque (see below)
	 * ptr    = Pointer returned by lzma_allocator.alloc(),
 ...
 *
 * Returns:
 *              How much memory is currently allocated for the filter
